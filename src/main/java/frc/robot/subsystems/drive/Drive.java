...
public class Drive extends SubsystemBase {
    ...
    public void periodic() {
        ...
        if (gyroInputs.connected) {
            ...
            if (noGyroPoseEstimation == null) {
                ...
                noGyroPoseEstimation = new SwerveDrivePoseEstimator(kinematics, pose.getRotation(), swerveModulePositions, pose);
            }
    ...
    public void setPose(Pose2d pose) throws GyroConnectionException {
        ...
        if (gyroInputs.connected)
            ...
            this.noGyroPoseEstimation.resetPosition(noGyroRotation, swerveModulePositions, pose);
        throw new GyroConnectionException("Pose estimator was written to without gyroscope data (idk what" +
    ...
    public static class GyroConnectionException extends Exception {
         ...
         * @since 1.7
         */
        public GyroConnectionException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
