    ...
    switch (sysIDMode) {
      case Disabled:
          ...
          climb.setDefaultCommand(
                  Commands.run(
                          () -> {
                              ...
                              climb.runRightVolts(MathUtil.applyDeadband(operatorController.getRightY(), 0.075) * 12);
                          },
                          climb));
        ...
        // prepare the shooter for dumping into the amp
          operatorController.y().onTrue(Commands.runOnce(() -> modeHelper.switchTo(Mode.AMP)));
